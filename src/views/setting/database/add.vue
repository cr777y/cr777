<template>
  <div style="padding: 30px;">
    ...
    <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
      ...
      <el-form-item label="用户数量限制" prop="limit">
      ...
      <el-form-item label="数据库密码" prop="databasePassword">
        <el-input type="password" v-model="ruleForm.databasePassword" autocomplete="off"></el-input>
      </el-form-item>
...
<script>
  export default {
    ...
    data() {
      ...
      var checkDatabasePassword = (rule, value, callback) => {
        if (!value) {
      ...
      return {
        ...
        rules: {
          ...
          databasePassword: [
            {required: true, validator: checkDatabasePassword, trigger: 'blur'}
          ],
          limit: [
